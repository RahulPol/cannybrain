...
$useruploadfolder = "ckeditor/plugins/imageuploader/uploads/".$_SESSION['user']->company_name."/";
$useruploadpath = $usersiteroot."$useruploadfolder/";
$foldershistory[] = $useruploadfolder;

//die(print_r($_SESSION['user']));
$useruploadpath = $_SERVER['DOCUMENT_ROOT']."/ckeditor/plugins/imageuploader/uploads/".$_SESSION['user']->company_name."/";
